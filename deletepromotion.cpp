...
DeletePromotion::DeletePromotion(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::DeletePromotion)
    , tableView(new QTableView(this)),
    model(new QSqlTableModel(this))
{
    ui->setupUi(this);
    // Set up the SQL Table Model
    model->setTable("promotions");  // Specify the table to display data from
...
void DeletePromotion::on_Delete_btn_clicked()
{
...
void DeletePromotion::refreshTable(){
